...
// OpenCode 2 plugins import from '@opencode/plugin'.
// The preview shipped under a different name entirely, '@opencode-ai/plugin', whose '/v2' subpath
// this plugin was first written against; that scope is now the v1 line and is not what the
// OpenCode 2 binary loads.
// Under OpenCode 1 the package resolves but exports no Plugin.define, so the failure is a missing
// export rather than a missing module.
// Importing dynamically catches both, which turns a cryptic error into instructions.
